...
{
    internal class TitleCaseCommand
    {
        ...
        private TitleCaseCommand(OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new TitleCaseCommand(commandService);
            //Instance.SetupCommands();
        }

        protected void SetupCommands()
        {
            SetupCommand(PackageIds.EditTitleCaseCommandId, new Replacement(x => GetUpperTitleCase(x)));
        }
        ...
        public string GetUpperTitleCase(string textOriginal)
        {
            string firstCharLower = textOriginal.Substring(0, 1).ToUpper();
