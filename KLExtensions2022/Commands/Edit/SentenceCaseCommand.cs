...
{
    internal class SentenceCaseCommand
    {
        public static DTE2 DTE { get; private set; }
        public static SentenceCaseCommand Instance { get; private set; }
        private OleMenuCommandService CommandService { get; set; }

        private delegate string Replacement(string original);

        private SentenceCaseCommand(OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new SentenceCaseCommand(commandService);
        }

        protected void SetupCommands()
        {
            SetupCommand(PackageIds.EditSentenceCaseCommandId, new Replacement(x => GetSentenceCase(x)));
        }
        ...
        public string GetSentenceCase(string textOriginal)
        {
            string text = textOriginal.ToSentenceCase();
            return text;
        }
